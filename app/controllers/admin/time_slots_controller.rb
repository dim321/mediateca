module Admin
  class TimeSlotsController < BaseController
    ...
    def generate
      ...
      # Generate one slot per local half-hour; DST days may have fewer or more than 48.
      slots = []
      day_start = zone.local(date.year, date.month, date.day, 0, 0)
      day_end = zone.local(date.next_day.year, date.next_day.month, date.next_day.day, 0, 0)
